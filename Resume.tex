...
\begin{Section} {Projects}
	...
	\end{comment}
		...
		{\URL{https://www.dropbox.com/sh/tz7wyf3goyyg38t/AACIl90_aplSk9kUh67B_EWAa?dl=0&preview=taxyio.pdf}
			{Project Specifications}}
		{February 2021-present}
		{ETL Data Pipeline}
		{Group Capstone Project}
		\item Extract data from \URL{https://www.courtlistener.com/api/}{existing repositories} using REST APIs.
		\item Automate workflow using \textbf{Airflow} and store JSON objects in \textbf{Mongo} backend.
		\item Communicate closely with our customer, \URL{https://www.taxy.io/}{Taxy.io} to insure compatibility with existing software.
