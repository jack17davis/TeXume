...
\begin{Section}{Education}
	...
	\begin{Education}{University of Massachusetts Boston}{May 2021}{Bachelor of Science in Computer Science, Minor in Mathematics}{3.7}{Graduated Magna Cum Laude}
		
		\begin{tabular}{ @{} >{\bfseries}l @{\hspace{4ex}} l }
			Languages          & Java, SQL, Python, JSP, Scheme, C\\
			Software \& Tools  & Git, Docker, Apache Airflow, Vim, Linux, LaTeX, Unity \\
...
\begin{Section} {Internships}
	...
	\begin{Job}{Web Development Intern}{January 2020-May 2021}{UMass Boston Computer Science Department}
		\item Maintained both front-end and back-end of \URL{http://serlwind.cs.umb.edu:8080/oats/}{tutoring website} that services the entire campus.
		\item Implemented code changes and bug fixes in \textbf{Java}, \textbf{JSP}, and \textbf{SQL}.
		\item Communicated directly with our customers to provide quality service.
	\end{Job}
...
\begin{Section} {Projects}
	...
	\begin{Project} {Data Pipeline for US Case Law}
		{\URL{https://github.com/drsooch/CS410-Pipeline}
			{github.com/drsooch/CS410-Pipeline}}
		{February 2021-May 2021}
		{ETL Data Pipeline}
		{Group Class Project}
		\item Extracted data from \URL{https://www.courtlistener.com/api/}{existing repositories} using REST APIs.
		\item Automated workflow using \textbf{Airflow} and store JSON objects in \textbf{Mongo} backend.
		\item Communicated closely with our customer, \URL{https://www.taxy.io/}{Taxy.io}, to insure compatibility with existing software.
